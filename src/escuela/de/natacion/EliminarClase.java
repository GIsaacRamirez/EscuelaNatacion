...
public class EliminarClase extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ConexionMySQL mysql = new ConexionMySQL();
                ...
                String Query = "DELETE FROM clienteclase WHERE IdClase="+jComboBox2.getSelectedItem().toString();        
                Statement st = Conexion.createStatement();
                st.executeUpdate(Query);
                
               Query = "DELETE FROM clasedia WHERE IdClase="+jComboBox2.getSelectedItem().toString();
                st.executeUpdate(Query);
                
                Query = "DELETE FROM clase WHERE IdClase="+jComboBox2.getSelectedItem().toString();
                st.executeUpdate(Query);
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarClase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarClase().setVisible(true);
            }
        });
    }
