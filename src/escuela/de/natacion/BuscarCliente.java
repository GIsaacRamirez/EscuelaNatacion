...
public class BuscarCliente extends javax.swing.JFrame {
     ...
     */
    public BuscarCliente(int op) {
        initComponents();
        Opcion=op;   
        
        if(Opcion==2)
        {
            jButton1.setText("Buscar Cliente a Modificar");
        }
        if(Opcion==3)
        {
            jButton1.setText("Buscar Cliente a Dar de Baja");
        }
    }
    ...
    private void initComponents() {
        ...
        lblBuscarCliente.setText("Buscar ID:");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtBuscarIdCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(65, 65, 65)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!txtBuscarIdCliente.getText().matches("^\\s*$"))
        {
            try
            {
                ...
                while(rs.next())
                {
                    ...
                    Cliente BuscCliente=new Cliente(id,Opcion);
